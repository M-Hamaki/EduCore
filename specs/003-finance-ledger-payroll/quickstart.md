...
1. The isolated implementation worktree at `C:\tmp\EduCore-finance` on branch `feature/003-finance-ledger-payroll`.
2. PHP 8.0+ at `C:\xampp\php\php.exe`.
...
# 2) Inventory the exact tracked/untracked/deleted local state at C:\xampp\htdocs\EduCore.
...
# 6) Prove C:\xampp\htdocs\EduCore was not modified by adoption.
...
```powershell
# From the worktree root C:\tmp\EduCore-finance
C:\xampp\php\php.exe tools\run_finance_test_migrations.php --database=educore_finance_codex_test
...
```powershell
C:\xampp\php\php.exe tests\run_finance_suite.php --database=educore_finance_codex_test
```
...
```powershell
C:\xampp\php\php.exe tests\finance_money_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_receipt_idempotency_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_receipt_reversal_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_period_close_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_payroll_calculation_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_reconciliation_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_gl_balance_contract_test.php
C:\xampp\php\php.exe tests\finance_control_account_reconciliation_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_budget_actuals_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_bus_subscription_integration_test.php
C:\xampp\php\php.exe tests\finance_prior_year_debt_migration_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_maker_checker_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_invariants_contract_test.php
C:\xampp\php\php.exe tests\finance_subledger_balances_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_receipt_granularity_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_staff_ledger_rules_contract_test.php
C:\xampp\php\php.exe tests\finance_staff_control_account_reconciliation_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_discount_concurrency_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_voucher_gl_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe tests\finance_upload_safety_contract_test.php
...
```powershell
C:\xampp\php\php.exe tests\finance_role_footer_coverage_contract_test.php
```
...
```powershell
C:\xampp\php\php.exe -l <each touched file>
